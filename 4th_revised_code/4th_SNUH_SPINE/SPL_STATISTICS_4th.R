...
##########################################DATA#######################################################################
pt_pre1 <- read_csv("./SPL/spl_pre_pt1.csv") #6842
pt_pre2 <- read_csv("./SPL/spl_pre_pt2.csv")
pt_post1 <- read_csv("./SPL/spl_post_pt1.csv")
pt_post2 <- read_csv("./SPL/spl_post_pt2.csv")
##########################################TEST#######################################################################
...
write.csv(table1, file = "./SPL/spl_baseline_characteristics.csv")

sink("./SPL/spl_visit_ttest.txt")
...
write_csv(result,"./SPL/spl_statistics_visit.csv")
...
write.csv(table2, file = "./SPL/spl_baseline_characteristics_drug.csv")
...
write_csv(result_drug,"./SPL/spl_statistics_drug.csv")


file.remove("./SPL/spl_first_condition_ID.csv")
file.remove("./SPL/spl_pre_patient_ID.csv")
file.remove("./SPL/spl_post_patient_ID.csv")
file.remove("./SPL/spl_pre_pt1.csv")
file.remove("./SPL/spl_pre_pt2.csv")
file.remove("./SPL/spl_post_pt1.csv")
file.remove("./SPL/spl_post_pt2.csv")
file.remove("./SPL/spl_total_pre.csv")
file.remove("./SPL/spl_total_pre2.csv")
file.remove("./SPL/spl_total_post.csv")
file.remove("./SPL/spl_total_post2.csv")
file.remove("./SPL/spl_total_visit.csv")
